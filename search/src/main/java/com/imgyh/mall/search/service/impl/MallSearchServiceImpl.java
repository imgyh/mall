package com.imgyh.mall.search.service.impl;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.TypeReference;
import com.imgyh.mall.common.es.SkuEsModel;
import com.imgyh.mall.common.utils.R;
import com.imgyh.mall.search.config.ElasticSearchConfig;
import com.imgyh.mall.search.constant.EsConstant;
import com.imgyh.mall.search.feign.ProductFeignService;
import com.imgyh.mall.search.service.MallSearchService;
import com.imgyh.mall.search.vo.AttrResponseVo;
import com.imgyh.mall.search.vo.BrandVo;
    ...
    private SearchResult buildSearchResult(SearchResponse response,SearchParam param) {
        ...
        if(param.getAttrs()!=null && param.getAttrs().size()>0){
            List<SearchResult.NavVo> collect = param.getAttrs().stream().map(attr -> {
                ...
                navVo.setLink("//search.mall.gyh.im/list.html?"+replace);
